...
////////////////////////////////////////////////////////////////////////////////
// Outline transformations (outline is array of objects of form {x: 0, y: 0})
////////////////////////////////////////////////////////////////////////////////
...
Sprite.prototype.collidedWith = function (otherThing) {
    ...
    return square(this.radius + otherThing.radius) >= square(dx) + square(dy);
};
...
var Ship = function () {
    ...
    this.outline = translate(Ship.outline, this.position.x, this.position.y);
...
Ship.prototype.destroy = function () {
    ...
    Fragment.generate(this.position, rand(Ship.minFragments, Ship.maxFragments));
};
...
var Asteroid = function (size, x, y, angle) {
    ...
    this.anglrSpeed = rand(-Asteroid.maxAbsAnglrSpeed, Asteroid.maxAbsAnglrSpeed);
...
var Torpedo = function (ship) {
    ...
    this.position = {x: ship.position.x + ship.radius*cos(ship.orientation),
    ...
    this.outline = translate(Torpedo.outline, this.position.x, this.position.y);
    this.outline = scale(this.outline, this.radius, this.position);
    this.outline = rotate(this.outline, this.orientation, this.position);
};
...
var Fragment = function (x, y) {
    ...
    this.outline = translate(Fragment.outline, this.position.x, this.position.y);
    this.outline = scale(this.outline, this.radius, this.position);
    this.outline = rotate(this.outline, this.orientation, this.position);
};
...
var init = function () {
    ...
    Ship.newLifeScore = 10000;   // get a new life every this many points
